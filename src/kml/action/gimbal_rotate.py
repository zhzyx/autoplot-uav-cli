...
class GimbalRotateAction(Action):
    ...
    def __init__(
        ...
        super().__init__(action_id, "gimbalRotate", {
            ...
            "wpml:gimbalPitchRotateAngle": gimbal_pitch_rotate_angle if gimbal_pitch_rotate_enable else 0,
            "wpml:gimbalRollRotateEnable": 1 if gimbal_roll_rotate_enable else 0,
            "wpml:gimbalRollRotateAngle": gimbal_roll_rotate_angle if gimbal_roll_rotate_enable else 0,
            "wpml:gimbalYawRotateEnable": 1 if gimbal_yaw_rotate_enable else 0,
            "wpml:gimbalYawRotateAngle": gimbal_yaw_rotate_angle if gimbal_yaw_rotate_enable else 0,
            "wpml:gimbalRotateTimeEnable": 1 if gimbal_rotate_time_enable else 0,
            "wpml:gimbalRotateTime": gimbal_rotate_time if gimbal_rotate_time_enable else 0
        })
